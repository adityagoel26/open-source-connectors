...
public class WebLogicV2Adapter extends GenericJndiJmsV2Adapter {

    private static final Logger LOG = LogUtil.getLogger(WebLogicV2Adapter.class);

    private ThreadLocal<JndiContext> _jndiContext;

    public WebLogicV2Adapter(AdapterSettings settings) {
        super(settings);
    }
