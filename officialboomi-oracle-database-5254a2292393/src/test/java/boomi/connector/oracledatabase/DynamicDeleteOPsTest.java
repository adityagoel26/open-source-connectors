...
import com.boomi.connector.oracledatabase.DynamicDeleteOperation;
import com.boomi.connector.oracledatabase.OracleDatabaseConnection;
import com.boomi.connector.testutil.SimpleTrackedData;

public class DynamicDeleteOPsTest {
	private OracleDatabaseConnection con = mock(OracleDatabaseConnection.class);
	private DynamicDeleteOperation ops = mock(DynamicDeleteOperation.class);
	...
	public static final String INPUT1 = TestUtil.readJsonFromFile("src/test/java/DynamicDelete.txt");
	...
	@Test
	public void testexecuteDeleteOperation() throws IOException {
		con.loadProperties();
