...
public class SFTPDeleteOperationTest {

	@Test
	public void testExecuteDeleteDeleteRequestOperationResponse()
			throws Exception {
		sftpDeleteOperation(SFTPTestConstants.TEST_EXECUTE_DELETE_DELETE_REQUEST_OPERATION_RESPONSE);
	}



	@Test
	public void testExecuteDeleteDeleteRequestOperationResponseDeleteFailed()
			throws Exception {
		sftpDeleteOperation(SFTPTestConstants.TEST_EXECUTE_DELETE_DELETE_REQUEST_OPERATION_RESPONSE_DELETE_FAILED);
	}
	

	@Test
	public void testExecuteDeleteDeleteRequestOperationResponseDeleteFailedException()
			throws Exception {
		sftpDeleteOperation(SFTPTestConstants.TEST_EXECUTE_DELETE_DELETE_REQUEST_OPERATION_RESPONSE_DELETE_FAILED_EXCEPTION);
	}
	
	@Test
	public void testExecuteDeleteDeleteRequestOperationResponseDeleteFailedOpenConnection()
			throws Exception {
		sftpDeleteOperation(
				SFTPTestConstants.TEST_EXECUTE_DELETE_DELETE_REQUEST_OPERATION_RESPONSE_DELETE_FAILED_OPEN_CONNECTION);
	}

	private static void sftpDeleteOperation(String testCase) throws Exception {
		...
		switch (testCase){
			case SFTPTestConstants.TEST_EXECUTE_DELETE_DELETE_REQUEST_OPERATION_RESPONSE_DELETE_FAILED_OPEN_CONNECTION:
		...
		switch (testCase){
			case SFTPTestConstants.TEST_EXECUTE_DELETE_DELETE_REQUEST_OPERATION_RESPONSE_DELETE_FAILED:
				SftpException ex = new SftpException(2, SFTPTestConstants.FILE_EXISTS);
				doThrow(ex).when(channel).rm(any(String.class));
				break;
			case SFTPTestConstants.TEST_EXECUTE_DELETE_DELETE_REQUEST_OPERATION_RESPONSE_DELETE_FAILED_EXCEPTION:
			case SFTPTestConstants.TEST_EXECUTE_DELETE_DELETE_REQUEST_OPERATION_RESPONSE_DELETE_FAILED_OPEN_CONNECTION:
				doThrow(new RuntimeException()).when(channel).rm(any(String.class));
				break;
			default:
				break;
		}
		...
		opProperty.put(SFTPConstants.OPERATION_PROP_ACTION_IF_FILE_EXISTS, SFTPTestConstants.OVERWRITE);
		...
		tester.setOperationContext(OperationType.DELETE, connProperty, opProperty, "File", null);
		tester.setBrowseContext(OperationType.DELETE, connProperty, opProperty);
		...
		objectIds.add("abc");
		objectIds.add("xyz");
		tester.executeDeleteOperation(objectIds);
	}
}
