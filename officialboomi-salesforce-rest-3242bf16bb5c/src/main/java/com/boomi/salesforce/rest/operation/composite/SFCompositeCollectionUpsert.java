...
public class SFCompositeCollectionUpsert extends SFCompositeUpdateOperations {
     ...
     */
    public SFCompositeCollectionUpsert(SFRestConnection connectionManager, UpdateRequest request,
                                       OperationResponse response, AtomConfig config, String sobjectName,
                                       String externalIdField) {
        super(connectionManager, request, response, config);
        _sobjectName = sobjectName;
        _externalIdField = externalIdField;
    }
    ...
    protected CompositeResponseSplitter executeUpdate(InputStream compositeBody) throws XMLStreamException {
        return _compositeController.upsertSObjectCollection(_sobjectName, _externalIdField, compositeBody);
    }
}
