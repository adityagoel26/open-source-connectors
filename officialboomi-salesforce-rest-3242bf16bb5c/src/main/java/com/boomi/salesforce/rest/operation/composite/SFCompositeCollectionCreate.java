...
public class SFCompositeCollectionCreate extends SFCompositeUpdateOperations {
     ...
     */
    public SFCompositeCollectionCreate(SFRestConnection connectionManager, UpdateRequest request,
    ...
    protected CompositeResponseSplitter executeUpdate(InputStream compositeBody) throws XMLStreamException {
        return _compositeController.createSObjectCollection(compositeBody);
    }
}
