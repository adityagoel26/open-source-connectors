...
/**
 * Implementation of UPSERT operation that processes the input documents using Salesforce BULK V2 API.
 */
public class SFBulkUpsertOperation extends SFSizeLimitUpdateOperation {

    SFBulkUpsertOperation(SFRestConnection connection) {
        super(connection);
    }
    ...
    protected void executeSFUpdate(UpdateRequest request, OperationResponse response) {
        ...
        getConnection().getOperationProperties().setBulkOperation(Constants.UPSERT_BULKV2);
