 ...
 *
 */
public class SAPConnectorBrowserTestContext extends ConnectorTestContext {
	...
	public SAPConnectorBrowserTestContext(){
		addConnectionProperty("hostName", "https://sandbox.api.sap.com/");
		...
		//addOperationProperty(key, value);
