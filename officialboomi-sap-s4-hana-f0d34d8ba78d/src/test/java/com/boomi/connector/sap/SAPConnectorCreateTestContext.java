 ...
 *
 */
public class SAPConnectorCreateTestContext extends ConnectorTestContext{
	...
	public SAPConnectorCreateTestContext() {
		...
		setObjectTypeId("/A_BusinessPartnerAddress(BusinessPartner='{BusinessPartner}',AddressID='{AddressID}')/to_EmailAddress");
	}
